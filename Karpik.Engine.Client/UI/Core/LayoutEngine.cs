...
public class LayoutEngine
{
    ...
    private void Calculate(UIElement parent, Rectangle availableSpace, Font font)
    {
        ...
        parent.LayoutBox.ContentRect = new Rectangle(finalX + borderLeft + paddingLeft,
    ...
    private float CalculateFlex(UIElement parent, Rectangle parentAvailableSpace, Font font)
    {
        ...
        foreach (var line in allLines)
        {
            ...
            foreach (var item in line.Items)
            {
                var tempAvailableSpace = new Rectangle(0, 0, isRow ? item.FinalMainSize : contentBox.Width,
                ...
                if (alignSelf == s.align_stretch)
                {
                    if (isRow)
                    {
                        ...
                        if (heightVal.Unit == Unit.Auto)
                        {
                            ...
                            itemElement.LayoutBox.ContentRect = new Rectangle(itemElement.LayoutBox.ContentRect.X,
        ...
        float bLeft, float bRight, float bTop, float bBottom)
    {
        ...
        element.LayoutBox.PaddingRect = new Rectangle(contentRect.X - pLeft, contentRect.Y - pTop,
            contentRect.Width + pLeft + pRight, contentRect.Height + pTop + pBottom);
        element.LayoutBox.BorderRect = new Rectangle(element.LayoutBox.PaddingRect.X - bLeft,
        ...
        element.LayoutBox.MarginRect = new Rectangle(element.LayoutBox.BorderRect.X - mLeft,
